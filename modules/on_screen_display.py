...
class OnScreenDisplay:
    ...
    def __init__(self, img, platform, sensor_info, parm_osd):
        self.img = img.copy()
    ...
    def apply_osd(self):
        ...
        self.img[self.x_offset: self.x_offset + height, self.y_offset: self.y_offset + width, 1] = logo
        self.img[self.x_offset: self.x_offset + height, self.y_offset: self.y_offset + width, 2] = logo
